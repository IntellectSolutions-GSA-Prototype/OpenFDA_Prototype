...
function parseParameters(data) {
  ...
  console.log("You searched for food name: " + data.Value + " which is of query type " + data.QueryType.Value + "!");
  return qString;
}

exports.findByName = function(req,res) {
  //var data = req.body;
  var data = JSON.parse('{"QueryType":{"Index":1,"Value":"Adverse Reactions"},"Value":"Test"}');
